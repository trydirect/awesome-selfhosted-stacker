...
## 5.1. Config Contract (`config_contract`)

The `config_contract` section declares environment variables for Stack Builder UI.
It uses the `fields` format with metadata for each variable:
...
config_contract:
  services:
    app:
      fields:
        SECRET_KEY:
          mutability: generated    # auto-generated by Stacker
          type: alphanumeric       # alphanumeric | base64 | hex
          length: 32               # length of generated value
          display: password        # password | boolean | number | text
        API_KEY:
          mutability: generated
          type: base64
          length: 40
          display: password
        DEBUG:
          mutability: editable     # user can edit in UI
          display: boolean
        PORT:
          mutability: editable
          display: number
        BASE_URL:
          mutability: editable     # no display = text input
    postgres:
      fields:
        POSTGRES_PASSWORD:
          mutability: generated
...
|----------|--------|-------------|
| `mutability` | `generated`, `editable` | `generated`: auto-created; `editable`: user sets in UI |
| `type` | `alphanumeric`, `base64`, `hex` | Character set for generated values |
| `length` | number | Length of generated value |
| `display` | `password`, `boolean`, `number`, `text` | UI widget type |
