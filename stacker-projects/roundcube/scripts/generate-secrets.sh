...
# generate-secrets.sh — generate random secrets for Roundcube
...
generate_if_empty ROUNDCUBE_SECRET_KEY 32

echo "[DONE] Secrets generated."
echo "[NOTE] ROUNDCUBE_IMAP_HOST and ROUNDCUBE_SMTP_HOST must be set manually."
