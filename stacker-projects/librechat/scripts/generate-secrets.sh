...
# generate-secrets.sh — generate random secrets for LibreChat
...
generate_if_empty CREDS_KEY 32
generate_if_empty CREDS_IV 16
generate_if_empty JWT_SECRET 64
generate_if_empty JWT_REFRESH_SECRET 64
