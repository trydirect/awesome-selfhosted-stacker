...
### 1. Pick a Project (preferably a tested one)
```bash
...
```
This creates `.env` with random secrets:
- DB passwords (32-char hex)
- API keys (64-char hex)
- Tokens (43-char base64)
...
**Full Example: Deploy WordPress locally**

```bash
# 1. Navigate to project
cd wordpress

# 2. Generate secrets (auto-creates .env)
./scripts/generate-secrets.sh

# 3. Verify secrets were generated
