...
# generate-secrets.sh — generate random secrets for OpenProject
...
generate_if_empty OPENPROJECT_SECRET_KEY_BASE 64
generate_if_empty OPENPROJECT_DATABASE_PASSWORD 24
