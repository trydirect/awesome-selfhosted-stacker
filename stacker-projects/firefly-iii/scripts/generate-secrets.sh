...
# generate-secrets.sh — generate random secrets for Firefly III
...
# APP_KEY must be 32 characters for Firefly III
generate_if_empty FIREFLY_III_APP_KEY 32
generate_if_empty FIREFLY_III_DATABASE_PASSWORD 24
