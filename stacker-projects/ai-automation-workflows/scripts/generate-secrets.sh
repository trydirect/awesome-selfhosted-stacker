...
generate_if_empty "FLOWISE_PASSWORD" "openssl rand -hex 16"
generate_if_empty "DB_PASSWORD"      "openssl rand -hex 16"
generate_if_empty "APIKEY_SECRET"    "openssl rand -hex 32"
generate_if_empty "SECRET_KEY"       "openssl rand -hex 32"
generate_if_empty "N8N_PASSWORD"     "openssl rand -hex 16"
