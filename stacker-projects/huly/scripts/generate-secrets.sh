...
# generate-secrets.sh — generate random secrets for Huly
...
generate_if_empty HULY_DATABASE_PASSWORD 24
generate_if_empty HULY_AUTH_SECRET 32
generate_if_empty HULY_SERVER_SECRET 32
