...
# generate-secrets.sh — generate random secrets for LimeSurvey
...
generate_if_empty LIMESURVEY_DATABASE_PASSWORD 24
generate_if_empty LIMESURVEY_ADMIN_PASSWORD 24
