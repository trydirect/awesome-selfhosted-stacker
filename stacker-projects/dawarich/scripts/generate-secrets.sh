...
# generate-secrets.sh — generate random secrets for Dawarich
...
generate_if_empty DAWARICH_DATABASE_PASSWORD 24
generate_if_empty DAWARICH_SECRET_KEY_BASE 64
generate_if_empty DAWARICH_ENCRYPTION_KEY 32
